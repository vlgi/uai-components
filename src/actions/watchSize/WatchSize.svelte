...
<div class="font-size">
  ...
  <input id="fontSize" type="range" bind:value={fontSize} max="5" min="0.1" step="0.1"/>
</div>

<div class="slow-adjust">
  <label for="slowAdjust">Slow size adjust</label>
  <input id="slowAdjust" type="checkbox" bind:checked={slowAdjust}/>
</div>
<div class="slot-adjust-target">
  <label for="slowAdjustTarget">Slow size adjust target</label>
  <input id="slowAdjustTarget" type="range" bind:value={target} max="1920" min="0.1" step="1"/>
</div>
