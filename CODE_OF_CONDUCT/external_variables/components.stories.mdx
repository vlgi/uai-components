...
<Meta title="Internal Documentation/Theme/Componets" />
...
You can use the `cssVariablesExtractor.js` script to make the task of list external variable more easly. Just run
`node tasks/cssVariablesExtractor.js src/components/MyComponent/MyComponent.svelte`
