...
<Meta title="Internal Documentation/Theme/Global theme variables" />

# Global theme variables

The project contains some global variables that is defined at `$styles/variables`.
...
[Theme/Components variables](?path=/story/code-of-conduct-theme-componets--page)

If you need some internal global variables (that is not a theme variable) just declare in the same
context file, but above the comment `internal variables only`.
